...
def main():
    ...
    ds = CSVDataset("C://Users//Ritika//Ritika//Github//SH//data//ball_train_sinkhole.csv", seq_len=21)
    val_ds = CSVDataset("C://Users//Ritika//Ritika//Github//SH//data//ball_train_sinkhole.csv", seq_len=21)
    ...
    model = train_model(model, cfg, train_ds, val_ds)
    model = train_model(model, cfg, train_ds, val_ds)
    ds = CSVDataset("C://Users//Ritika//Ritika//Github//SH//data//ball_train_sinkhole_2.csv", seq_len=14)
    val_ds = CSVDataset("C://Users//Ritika//Ritika//Github//SH//data//ball_train_sinkhole_2.csv", seq_len=14)
    train_ds = ds
    model = train_model(model, cfg, train_ds, val_ds)
    ...
    new_ds = CSVDataset("C://Users//Ritika//Ritika//Github//SH//data//ball_test_sinkhole.csv", seq_len=1)
    ...
    #     #X = X.to(device)
    #     logits = model(X)
    new_ds = CSVDataset("C://Users//Ritika//Ritika//Github//SH//data//ball_test_no_sinkhole.csv", seq_len=1)
    new_loader = torch.utils.data.DataLoader(new_ds, batch_size=1, shuffle=False)
    with torch.no_grad():
        for X, _ in new_loader:
            X = X.to(cfg.device)
